    ...
    >
      ...
      <div className="scarlet-home__shell">
        ...
        <p className="scarlet-home__fixture-note">
          {loading
            ? "Riapro il nostro spazio…"
            : connectionError
              ? "Connessione assente · nessun dato sostitutivo"
              : "Spazio sincronizzato"}
        </p>
      </div>
    ...
    <div data-testid="home-dashboard">
      <section className="scarlet-home__hero" aria-labelledby="home-title">
        <div className="scarlet-home__hero-copy">
          ...
          <p>
            {loading
              ? "Sto riaprendo il nostro spazio e i fili più recenti."
              : connectionError
                ? "Una parte del nostro spazio non è raggiungibile. Possiamo comunque restare qui e riprovare."
                : "Il nostro spazio è aggiornato. Possiamo riprendere una conversazione oppure aprirne una nuova."}
          </p>
