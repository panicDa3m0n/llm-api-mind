...
Current additive contract target: V1.56.0
...
|---|---|---|---|---|
| Application composition | `backend/app/main.py`, `backend/app/asgi.py` | deployment and tests | app V1.56.0 target | Stable factory and ASGI entrypoint over the closed V1.50.1 Core. |
