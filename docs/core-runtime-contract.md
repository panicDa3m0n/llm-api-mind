...
|---|---|---|---|---|
| Application composition | `backend/app/main.py`, `backend/app/asgi.py` | deployment and tests | app V1.64.0 deployed | Stable factory and ASGI entrypoint over the closed V1.50.1 Core. |
