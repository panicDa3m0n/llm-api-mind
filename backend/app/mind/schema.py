...
MIND_API_SCHEMA_VERSION = "2026-05-25.memory-proposals-v1"
...
MIND_API_ROUTES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "status": "implemented",
        "purpose": (
            "Inspect pending memory maintenance proposals generated by idle "
            "review. Proposals are not active memories; they carry evidence, "
            "similar-memory preflight, and a suggested lifecycle action."
        ),
        "body_schema": {
            "type": "object",
            "properties": {
                "status": {
                    ...
                    "default": "pending",
                    "description": (
                        "Proposal status filter. Use pending for open review "
                        "items, null or all to inspect every proposal."
                    ),
                },
                "source_session_id": {
                    "type": ["string", "null"],
                    "description": (
                        "Optional session id whose maintenance proposals should "
                        "be inspected."
                    ),
                },
                "limit": {
        ...
        "examples": [
            {
                "method": "GET",
                "path": "/mind/memory/proposals",
                "intent": "Inspect pending missed-memory proposals before deciding lifecycle actions.",
...
def route_catalog_suggestions(method: str, path: str) -> list[dict[str, str]]:
    ...
    return [item for _, item in suggestions[:6]]
